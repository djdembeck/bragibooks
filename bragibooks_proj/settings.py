...
allowed_hosts_env = os.getenv("ALLOWED_HOSTS", "localhost,127.0.0.1").strip()
ALLOWED_HOSTS = [
...
CSRF_TRUSTED_ORIGINS = [
    v.strip() for v in csrf_origins_env.split(",") if v.strip()
] or []
...
CELERY_BROKER_URL = os.environ.get(
    "BROKER_URL", f"sqla+sqlite:///{os.path.join(CONFIG_DIR, 'db.sqlite3')}"
)
